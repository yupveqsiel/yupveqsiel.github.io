...
const collectionInfo = {
    name: "METAKAMI™ MINT",
    title: "METAKAMI™", // Title prefix (ex "Buy your {name}") - You can use {name} to insert the collection name
    socialMedia: {
...
const mintInfo = {
    price: 0.06,         // Price per NFT.
    totalSupply: 444,   // Total supply of NFTs.
